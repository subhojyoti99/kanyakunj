  ...
  return (
    <div style={{ maxWidth: 1280, margin: "0 auto", padding: "48px 24px" }}>
      ...
      >
        {/* Images */}
        <div>
          <div style={{ paddingTop: "133%", position: "relative", background: "#f5ede8", marginBottom: 12 }}>
            <img
        ...
        <div style={{ position: "sticky", top: 100 }}>
          ...
          >
            {added ? "✓ Added to Bag!" : allAttrsSelected ? "Add to Bag" : "Select Options Above"}
          </button>

          <button className="btn-outline" style={{ width: "100%", fontSize: 12 }} suppressHydrationWarning>
            ♡ Add to Wishlist
          </button>
